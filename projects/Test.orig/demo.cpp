...
#include "phys/units/quantity_io_symbols.hpp"   // operator<< and unit names and symbols
#include "phys/units/quantity_io_engineering.hpp"   // operator<< and unit names and symbols
...
{
   {
    ...
    phys::units::quantity< power_d > sum( phys::units::quantity< power_d >::zero() );
