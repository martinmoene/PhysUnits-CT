 ...
 * \author  Michael S. Kenniston (added type promotion, Martin Moene)
...
inline quantity< length_d, float > meter_f()
{
   return quantity< length_d, float >( detail::permit<float>( 1.0f ) );
}

inline quantity< length_d, double > meter_d()
{
   return quantity< length_d, double >( detail::permit<double>( 1.0 ) );
}

inline quantity< length_d, long double > meter_ld()
{
   return quantity< length_d, long double >( detail::permit<long double>( 1.0L ) );
}
