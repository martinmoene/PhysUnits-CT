...
int main()
{
    quantity< power_d > qp( 2 * watt() );
    quantity< energy_d > qe( 3 * joule() );
    Rep x( 5.6 );
    bool b( true );
    ...
    #ifdef FAIL_46
        cout << nth_root< 0 >( meter() );
    #endif

    #ifdef FAIL_461
        cout << nth_root< 3 >( meter() );
    #endif

    #ifdef FAIL_47
        cout << nth_root< 4 >( meter() * meter() * meter() * meter() * second() * second() * second() );
    #endif
